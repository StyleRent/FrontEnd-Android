...
public class NewProductActivity extends AppCompatActivity {
    ...
    List<ProductImageView> productImageViewList = new ArrayList<>(); // DI - Dependency Inversion Principle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category = findViewById(R.id.category_etv);
        ...
        addProductBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(NewProductActivity.this)
...
//            //사진
            ...
            if(name.getText().toString().isEmpty()){
                Toast.makeText(NewProductActivity.this, "please enter product name! ", Toast.LENGTH_SHORT).show();
            }else if(price.getText().toString().isEmpty()){
                Toast.makeText(NewProductActivity.this, "please enter product Price! ", Toast.LENGTH_SHORT).show();
            }else if(description.getText().toString().isEmpty()){
                Toast.makeText(NewProductActivity.this, "please enter product Description! ", Toast.LENGTH_SHORT).show();
            } else if (productImageViewList.size() == 0) {
                Toast.makeText(NewProductActivity.this, "Please add product Image! ", Toast.LENGTH_SHORT).show();
            } else{
    ...
    private void addProductInfo(ProductInfoRequest productInfoRequest){
        String TOKEN = sharedPreferences.getString("TOKEN", null);

        ApiInterface apiInterface = RetrofitClient.getRetrofitInstance(NewProductActivity.this).create(ApiInterface.class);
        Call<ProductInfoResponse> addInfoApi = apiInterface.productAddInfo("Bearer" + TOKEN, productInfoRequest);
        addInfoApi.enqueue(new Callback<ProductInfoResponse>() {
            @Override
            public void onResponse(Call<ProductInfoResponse> call, Response<ProductInfoResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(NewProductActivity.this, "옷장 정보 추가되었습니다 ", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
...
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && data != null) {
            if (productImageViewList.size() < 4) {
                productImageViewList.add(new ProductImageView(data.getData(), new File(data.getData().getPath())));
        ...
        if(uri != null && imagePath != null){
            ...
            call.enqueue(new Callback<ProductImageResponse>() {
                ...
                public void onResponse(Call<ProductImageResponse> call, Response<ProductImageResponse> response) {
                    ...
                    Toast.makeText(NewProductActivity.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(NewProductActivity.this, "Profile image has not been changed", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showProductImage() {
        ...
        int numberOfImages = productImageViewList.size();
        ...
        for (int i = 0; i < numberOfImages; i++) {
            ...
            FrameLayout imageContainer = new FrameLayout(NewProductActivity.this); // Make imageContainer final
            ...
            productImage = new ImageButton(NewProductActivity.this);
            ...
            Uri imageUri = productImageViewList.get(i).getUri();
            ...
            ImageView removeIcon = new ImageView(NewProductActivity.this);
